...
public abstract class BaseDao<M extends Serializable, PK extends Serializable> implements InitializingBean, IDao<M, PK> {
    @Autowired
                    ...
                    if (recordList != null) {
                        ...
                        while(var5.hasNext()) {
                            ...
                            while(var8.hasNext()) {
                                ...
                                try {
                                    String methodSuffixName = BaseDao.this.buildSuffixName(value.getClass().getSimpleName());
